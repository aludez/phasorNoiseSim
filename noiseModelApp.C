...
void StandaloneApplication(int argc, char** argv)
{
  ...
  if (argc == 5){
    ...
    TString a3 = argv[3];
    int a3i = a3.Atoi();
    phasorModel(argv[1], a2d, a3i, argv[4]);
  }
  if (argc == 6){
    TString a2 = argv[2];
    double a2d = a2.Atof();
    ...
    TString a5 = argv[5];
    int a5i = a5.Atoi();
    phasorModel(argv[1], a2d, a3i, argv[4], a5i);
  }
  if (argc == 7){
    TString a2 = argv[2];
    double a2d = a2.Atof();
    ...
    TString a5 = argv[5];
    int a5i = a5.Atoi();
    phasorModel(argv[1], a2d, a3i, argv[4], a5i, argv[6]);
  }
  exit(0);
}
